...
export const verifyOtp = ({ jwt, otp }) => {
  ...
  return async (dispatch) => {
    ...
    try {
      // Обратите внимание: этот эндпоинт может быть неправильным, так как он отсутствует в списке бэкенда
      // Возможно, нужно использовать другой эндпоинт для верификации OTP
