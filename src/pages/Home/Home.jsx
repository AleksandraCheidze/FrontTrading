...
const Home = () => {
  ...
  useEffect(() => {
    // Only fetch coin details if user is authenticated
          ...
          {auth.user ? (
            ...
            <div className="flex flex-col items-center justify-center h-full">
              <h2 className="text-2xl font-bold mb-4">
                Welcome to Cassandra Trading
              </h2>
              <p className="text-center mb-6">
                Sign in to view detailed charts and market data
              </p>
