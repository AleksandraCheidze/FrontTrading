...
const Auth = () => {
  ...
  // If we're at the root path, redirect to home immediately
  if (location.pathname === "/" || location.pathname === "") {
    // This is a direct render-time check, not an effect
  ...
  return (
    <div className={`authContainer h-screen relative`}>
      ...
      >
        ...
        <h1 className="text-6xl font-bold pb-9">Cassandra Trading</h1>
        {/* <Avatar>
